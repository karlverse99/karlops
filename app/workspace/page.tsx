      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap', flexShrink: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
            <button onClick={() => { setTaskAddInitialRaw(undefined); setShowTaskAdd(true); }} style={{ background: '#1c1910', border: '1px solid #ca8a04', color: '#fbbf24', padding: '0.3rem 0.65rem', borderRadius: '4px', fontFamily: 'monospace', fontSize: '0.7rem', cursor: 'pointer' }} onMouseEnter={e => (e.currentTarget.style.background = '#29231a')} onMouseLeave={e => (e.currentTarget.style.background = '#1c1910')}>+add task(s)</button>
