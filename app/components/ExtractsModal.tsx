          ...
          <div key="tags" style={{ marginBottom: '0.85rem' }}>
            ...
            <div style={{ display: 'flex', gap: '0.5rem' }}>
              ...
              <div style={{ position: 'relative', flex: 1 }}>
                <input value={tagSearch} onChange={e => { setTagSearch(e.target.value); setShowTagDrop(true); }} onFocus={e => { setShowTagDrop(true); e.target.style.borderColor = ACCENT; }} onBlur={e => { setTimeout(() => setShowTagDrop(false), 150); e.target.style.borderColor = '#ddd'; }} placeholder="Search tags..." style={{ ...inputStyle, marginBottom: 0 }} />
